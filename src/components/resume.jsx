        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3">
              <nav id="navi">
                <ul>
                  <li><a href="#page-1" className>Education</a></li>
                  <li><a href="#page-2" className>Experience</a></li>
                  ...
                  <div className="col-lg-4 mb-4">
                    <div className="bg-white rounded-lg shadow p-4">
                      ...
                      <div className="progress mx-auto" data-value={75}>
                        <span className="progress-left">
                          <span className="progress-bar border-primary" style={{transform: 'rotate(90deg)'}} />
                        </span>
                        <span className="progress-right">
                          <span className="progress-bar border-primary" style={{transform: 'rotate(180deg)'}} />
                        </span>
